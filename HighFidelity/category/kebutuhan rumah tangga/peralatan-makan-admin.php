...
<body>
        ...
        <div class="row">
            <div class="col-md-3 order-first mt-2">
                <li class="list-group-item">
                    <a href="peralatan-kebersihan-admin.php" class="text-dark">Peralatan Kebersihan</a>
                </li>

                <li class="list-group-item bg-primary">
                    <a href="peralatan-makan-admin.php" class="text-light">Peralatan Makan</a>
                </li>

                <li class="list-group-item">
                    <a href="peralatan-rumah-tangga-admin.php" class="text-dark">Peralatan Rumah Tangga</a>
                </li>
                <br>
            ...
            <div class="col-md-9 order-last mt-2">
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM barang WHERE kategori='PeralatanMakan' LIMIT $mulai, $halaman";
                    $result1 = mysqli_query($conn,"SELECT * FROM barang WHERE kategori='PeralatanMakan'");
                    $no = $mulai + 1;
    ...
    <div class="wrapper">
        <?php
            ...
            $sql = "SELECT * FROM barang WHERE kategori='PeralatanMakan' ORDER BY idbarang ASC";
                    ...
                    <div class="modal-body">
                        <form id="input" action="../../inputbarang-proses.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="kbarang" placeholder="Enter kategori barang" name="kbarang" value="PeralatanMakan">
                            </div>
                            <div class="form-group">
