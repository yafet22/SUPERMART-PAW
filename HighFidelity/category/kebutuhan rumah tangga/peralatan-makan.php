        ...
        <div class="row">
            <div class="col-md-3 order-first mt-2">
                <li class="list-group-item">
                    <a href="peralatan-kebersihan.php" class="text-dark">Peralatan Kebersihan</a>
                </li>

                <li class="list-group-item bg-primary">
                    <a href="peralatan-makan.php" class="text-light">Peralatan Makan</a>
                </li>

                <li class="list-group-item">
                    <a href="peralatan-rumah-tangga.php" class="text-dark">Peralatan Rumah Tangga</a>
                </li>
            </div>
