        ...
        <div class="row">
            <div class="col-md-3 order-first mt-2">
                <li class="list-group-item bg-primary">
                    <a href="peralatan-kebersihan-admin.php" class="text-light">Peralatan Kebersihan</a>
                </li>

                <li class="list-group-item">
                    <a href="peralatan-makan-admin.php" class="text-dark">Peralatan Makan</a>
                </li>
                    ...
                    <div class="modal-body">
                        <form id="input" action="../../inputbarang-proses.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="kbarang" placeholder="Enter kategori barang" name="kbarang" value="PeralatanKebersihan">
                            </div>
                            <div class="form-group">
