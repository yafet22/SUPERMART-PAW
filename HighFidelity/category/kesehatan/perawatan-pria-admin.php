        ...
        <div class="row">
            <div class="col-md-3 order-first mt-2">
                ...
                <li class="list-group-item bg-primary">
                    <a href="perawatan-pria-admin.php" class="text-light">Perawatan Pria</a>
                </li>
                    ...
                    <div class="modal-body">
                        <form id="input" action="../../inputbarang-proses.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="kbarang" placeholder="Enter kategori barang" name="kbarang" value="PerawatanPria">
                            </div>
                            <div class="form-group">
