   ...
   <nav id="sidebar" style="height:390px">
        ...
        <div class="row">
            <div class="col-md-3 order-first mt-2">
                ...
                <li class="list-group-item bg-primary">
                    <a href="perawatan-pria.php" class="text-light">Perawatan Pria</a>
                </li>
            ...
            <div class="col-md-9 order-last mt-2">
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM barang WHERE kategori='PerawatanPria' LIMIT $mulai, $halaman";
                    $result1 = mysqli_query($conn,"SELECT * FROM barang WHERE kategori='PerawatanPria'");
                    $no = $mulai + 1;
    ...
    <div class="wrapper">
        <?php
            ...
            $sql = "SELECT * FROM barang WHERE kategori='PerawatanPria' ORDER BY idbarang ASC";
