...
<body>
        ...
        <div class="row">
            <div class="col-md-3 order-first mt-2">
                <li class="list-group-item">
                    <a href="perawatan-diri.php" class="text-dark">Perawatan Diri</a>
                </li>

                <li class="list-group-item bg-primary">
                    <a href="perawatan-badan.php" class="text-light">Perawatan Badan</a>
                </li>

                <li class="list-group-item">
                    <a href="perawatan-rambut.php" class="text-dark">Perawatan Rambut</a>
                </li>

                <li class="list-group-item">
                    <a href="perawatan-pria.php" class="text-dark">Perawatan Pria</a>
                </li>

                <li class="list-group-item">
                    <a href="obat-obatan.php" class="text-dark">Obat-obatan</a>
                </li>
            </div>
            ...
            <div class="col-md-9 order-last mt-2">
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM barang WHERE kategori='PerawatanBadan' LIMIT $mulai, $halaman";
                    $result1 = mysqli_query($conn,"SELECT * FROM barang WHERE kategori='PerawatanBadan'");
                    $no = $mulai + 1;
    ...
    <div class="wrapper">
        <?php
            ...
            $sql = "SELECT * FROM barang WHERE kategori='PerawatanBadan' ORDER BY idbarang ASC";
