...
<body>
        ...
        <div class="row">
            <div class="col-md-3 order-first mt-2">
                <li class="list-group-item bg-primary">
                    <a href="perawatan-diri.php" class="text-light">Perawatan Diri</a>
                </li>

                <li class="list-group-item">
                    <a href="perawatan-badan.php" class="text-dark">Perawatan Badan</a>
                </li>
            ...
            <div class="col-md-9 order-last mt-2">
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM barang WHERE kategori='PerawatanDiri' LIMIT $mulai, $halaman";
                    $result1 = mysqli_query($conn,"SELECT * FROM barang WHERE kategori='PerawatanDiri'");
                    $no = $mulai + 1;
    ...
    <div class="wrapper">
        <?php
            ...
            $sql = "SELECT * FROM barang WHERE kategori='PerawatanDiri' ORDER BY idbarang ASC";
