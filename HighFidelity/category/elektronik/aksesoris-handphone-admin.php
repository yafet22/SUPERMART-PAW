        ...
        <div class="row">
            <div class="col-md-3 order-first mt-2">
                ...
                <li class="list-group-item bg-primary">
                    <a href="aksesoris-handphone-admin.php" class="text-light">Aksesoris Handphone</a>
                </li>
                <br>
            ...
            <div class="col-md-9 order-last mt-2">
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM barang WHERE kategori='AksesorisHP' LIMIT $mulai, $halaman";
                    $result1 = mysqli_query($conn,"SELECT * FROM barang WHERE kategori='AksesorisHP'");
                    $no = $mulai + 1;
                    ...
                    <div class="modal-body">
                        <form id="input" action="../../inputbarang-proses.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="kbarang" placeholder="Enter kategori barang" name="kbarang" value="AksesorisHP">
                            </div>
                            <div class="form-group">
