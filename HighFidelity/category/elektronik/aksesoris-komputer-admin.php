...
<body>
        ...
        <div class="row">
            <div class="col-md-3 order-first mt-2">
                <li class="list-group-item">
                    <a href="televisi-admin.php" class="text-dark">Televisi</a>
                </li>

                <li class="list-group-item bg-primary">
                    <a href="aksesoris-komputer-admin.php" class="text-light">Aksesoris Komputer</a>
                </li>

                <li class="list-group-item">
                    <a href="aksesoris-handphone-admin.php" class="text-dark">Aksesoris Handphone</a>
                </li>
                <br>
            ...
            <div class="col-md-9 order-last mt-2">
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM barang WHERE kategori='AksesorisKomputer' LIMIT $mulai, $halaman";
                    $result1 = mysqli_query($conn,"SELECT * FROM barang WHERE kategori='AksesorisKomputer'");
                    $no = $mulai + 1;
    ...
    <div class="wrapper">
        <?php
            ...
            $sql = "SELECT * FROM barang WHERE kategori='AksesorisKomputer' ORDER BY idbarang ASC";
                    ...
                    <div class="modal-body">
                        <form id="input" action="../../inputbarang-proses.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="kbarang" placeholder="Enter kategori barang" name="kbarang" value="AksesorisKomputer">
                            </div>
                            <div class="form-group">
