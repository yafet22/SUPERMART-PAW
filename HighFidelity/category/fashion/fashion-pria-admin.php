...
<body>
        ...
        <div class="row">
            <div class="col-md-3 order-first mt-2">
                <li class="list-group-item bg-primary">
                    <a href="fashion-pria-admin.php" class="text-light">Fashion Pria</a>
                </li>

                <li class="list-group-item">
                    <a href="fashion-wanita-admin.php" class="text-dark">Fashion Wanita</a>
                </li>
                <br>
            ...
            <div class="col-md-9 order-last mt-2">
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM barang WHERE kategori='FashionPria' LIMIT $mulai, $halaman";
                    $result1 = mysqli_query($conn,"SELECT * FROM barang WHERE kategori='FashionPria'");
                    $no = $mulai + 1;
    ...
    <div class="wrapper">
        <?php
            ...
            $sql = "SELECT * FROM barang WHERE kategori='FashionPria' ORDER BY idbarang ASC";
                    ...
                    <div class="modal-body">
                        <form id="input" action="../../inputbarang-proses.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="kbarang" placeholder="Enter kategori barang" name="kbarang" value="FashionPria">
                            </div>
                            <div class="form-group">
